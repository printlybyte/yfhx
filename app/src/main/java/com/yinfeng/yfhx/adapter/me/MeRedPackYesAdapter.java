...
public class MeRedPackYesAdapter extends BaseQuickAdapter<SaveCardNotFragmentBean.DataBean.EnbaleBean, MeRedPackYesAdapter.MyHolder> {

    public MeRedPackYesAdapter(int layoutResId, List data) {
        super(layoutResId, data);
    }


    @Override
    protected void convert(@NonNull MeRedPackYesAdapter.MyHolder helper, SaveCardNotFragmentBean.DataBean.EnbaleBean item) {
