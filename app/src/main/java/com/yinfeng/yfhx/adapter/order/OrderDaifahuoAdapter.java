 ...
 * ============================================
 **/
public class OrderDaifahuoAdapter extends BaseQuickAdapter<OrderActivityBean.DataBean.ListBean, OrderDaifahuoAdapter.MyHolder> {


    private Context context = Latte.getApplicationContext();

    public OrderDaifahuoAdapter(int layoutResId, List data) {
    ...
    protected void convert(@NonNull MyHolder helper, OrderActivityBean.DataBean.ListBean item) {
        ...
        helper.setText(R.id.ri_daifahuo_item_order_sn, item.getOrder_sn() == "" ? tipStr : "订单号：" + item.getOrder_sn());
        helper.setText(R.id.ri_daifahuo_item_order_time, item.getOrder_time() == "" ? tipStr : "下单时间：" + item.getOrder_time());
        helper.setText(R.id.ri_daifahuo_item_shop_name, item.getShop_name() == "" ? tipStr : item.getShop_name());
        helper.setText(R.id.ri_daifahuo_item_order_status, item.getOrder_status() == "" ? tipStr : item.getOrder_status());
        helper.setText(R.id.ri_daifahuo_item_total_price, item.getTotal_amount_formated() == "" ? tipStr : "" + item.getTotal_amount_formated());
        helper.setText(R.id.ri_daifahuo_item_total_nums, item.getOrder_goods().size() + "" == "" ? tipStr : "共" + item.getOrder_goods().size() + "件商品：");

        helper.addOnClickListener(R.id.ri_daifahuo_item_group);
    ...
    class MyHolder extends BaseViewHolder {
        ...
        public MyHolder(View view) {
            ...
            mContainer = view.findViewById(R.id.ri_daifahuo_item_container);
    ...
    public View addView(String title, boolean isBga, MyHolder helper) {
        LinearLayout mFooterLayout = helper.itemView.findViewById(R.id.ri_daifahuo_item_container);
