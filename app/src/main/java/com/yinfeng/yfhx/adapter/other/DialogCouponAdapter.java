package com.yinfeng.yfhx.adapter.other;
 ...
 * ============================================
 **/
public class DialogCouponAdapter extends BaseQuickAdapter<TabFragment2Bean_Group.DataBean, DialogCouponAdapter.MyHolder> {

    public DialogCouponAdapter(int layoutResId, List data) {
