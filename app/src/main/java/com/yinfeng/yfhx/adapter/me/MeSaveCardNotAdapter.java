...
public class MeSaveCardNotAdapter extends BaseQuickAdapter<SaveCardNotFragmentBean.DataBean.UnableBean, MeSaveCardNotAdapter.MyHolder> {

    public MeSaveCardNotAdapter(int layoutResId, List data) {
        super(layoutResId, data);
    }


    @Override
    protected void convert(@NonNull MeSaveCardNotAdapter.MyHolder helper, SaveCardNotFragmentBean.DataBean.UnableBean item) {
