 ...
 * ============================================
 **/
public class FragmentEvaluation_Img extends BaseFragment {
    private RecyclerView mIncludeRecyclerview;
    private SmartRefreshLayout mRefreshLayout;
    private MultipleStatusView mMultipleStatusView;

    private static String mGoods_id="";
    public static FragmentEvaluation_Img newInstance(String good_id) {
        Bundle args = new Bundle();
        mGoods_id=good_id;
        FragmentEvaluation_Img generalPurposeFragment = new FragmentEvaluation_Img();
