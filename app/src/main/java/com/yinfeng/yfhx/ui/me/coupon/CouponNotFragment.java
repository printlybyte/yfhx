 ...
 * ============================================
 **/
public class CouponNotFragment extends BaseFragment {
    private RecyclerView mIncludeRecyclerview;
    private SmartRefreshLayout mRefreshLayout;
    private MultipleStatusView mMultipleStatusView;


    public static CouponNotFragment newInstance() {
        Bundle args = new Bundle();
        CouponNotFragment generalPurposeFragment = new CouponNotFragment();
    ...
    protected int getContentLayoutId() {
        return R.layout.fragment_me_coupon_not;
    }
    ...
    private void setAdapter(CouponNotFragmentBean bean) {
        MeCouponAdapter meCouponAdapter = new MeCouponAdapter(generateData(bean),0);
