 ...
 * ============================================
 **/
public class CouponYesFragment extends BaseFragment {
    private RecyclerView mIncludeRecyclerview;
    private SmartRefreshLayout mRefreshLayout;
    private MultipleStatusView mMultipleStatusView;


    public static CouponYesFragment newInstance() {
        Bundle args = new Bundle();
        CouponYesFragment generalPurposeFragment = new CouponYesFragment();
    ...
    protected int getContentLayoutId() {
        return R.layout.fragment_me_coupon_yes;
    }
    ...
    private void requestDate() {
        new OKBuilder(getActivity())
                .setNetUrl(Api.coupon_coupon_get + "?page=1&size=200&type=1")
                .get()
    ...
    private void setAdapter(CouponNotFragmentBean bean) {
        MeCouponAdapter meCouponAdapter = new MeCouponAdapter(generateData(bean),1);
