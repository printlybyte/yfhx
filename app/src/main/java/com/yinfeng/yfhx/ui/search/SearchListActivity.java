...
public class SearchListActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        jump_keywords = intent.getStringExtra(IntentUtilsConstant.INTENT_PARAMS_1);
        if (TextUtils.isEmpty(jump_keywords)) {
    ...
    private void requestDate() {
        ...
        mParamsMapx.put("keywords", jsonArray.toString());
