 ...
 * ============================================
 **/
public class MeRedPackFragmentYes extends BaseFragment {
    private RecyclerView mIncludeRecyclerview;
    private SmartRefreshLayout mRefreshLayout;
    private MultipleStatusView mMultipleStatusView;
    private int mPage = 1;
    public static MeRedPackFragmentYes newInstance() {
        Bundle args = new Bundle();
        MeRedPackFragmentYes generalPurposeFragment = new MeRedPackFragmentYes();
    ...
    private MeRedPackYesAdapter yesAdapter;

    private void setAdapter(SaveCardNotFragmentBean bean) {
        yesAdapter = new MeRedPackYesAdapter(R.layout.ri_me_redpack_item, bean.getData().getEnbale());
