...
import com.yinfeng.yfhx.adapter.order.OrderDaifahuoAdapter;
 ...
 * ============================================
 **/
public class OrderDaiFahuoFragment extends BaseFragment {
...
//        mIncludeRecyclerview.setNestedScrollingEnabled(false);
        daifahuoAdapter = new OrderDaifahuoAdapter(R.layout.ri_daifahuo_item, bean.getData().getList());
        daifahuoAdapter.openLoadAnimation();
        mIncludeRecyclerview.setAdapter(daifahuoAdapter);
        daifahuoAdapter.setOnItemChildClickListener(onItemChildClickListener);
                    ...
                    public void setOnCallBackResponseSuccess(String response) {
                        ...
                        if (beanx.getStatus().equals("success")) {
                            ...
                            if (bean != null && bean.getData().getList().size() > 0) {
                                if (isLoading) {
                                    daifahuoAdapter.addData(bean.getData().getList());
                                } else {
                                    setAdapter(bean);
                                }
