 ...
 * ============================================
 **/
public class ShopCategrayFragment extends BaseFragment {
    ...
    public static ShopCategrayFragment newInstance(String ru_id) {
        Bundle args = new Bundle();
        mRu_id = ru_id;
        ShopCategrayFragment generalPurposeFragment = new ShopCategrayFragment();
