 ...
 * 类  名：AD_BEAN
 * 创建人：liuguodong
 * 创建时间：2019/11/26 14:46
 * ============================================
 **/
public class AD_BEAN {

    private List<PriviceBean> privice;

    public List<PriviceBean> getPrivice() {
        return privice;
    }

    public void setPrivice(List<PriviceBean> privice) {
        this.privice = privice;
    }

    public static class PriviceBean {
        /**
         * code : 11
         * name : 北京市
