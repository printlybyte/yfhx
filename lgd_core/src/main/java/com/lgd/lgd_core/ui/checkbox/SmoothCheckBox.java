package com.lgd.lgd_core.ui.checkbox;

/**
 * ============================================
 * 描  述：
 * 包  名：com.lgd.lgd_core.ui.checkbox
 * 类  名：SmoothCheckBox
 * 创建人：liuguodong
 * 创建时间：2019/10/21 10:31
 * ============================================
 **/
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, CommonUtils.dp2px(getContext(), 0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = CommonUtils.dp2px(getContext(), DEF_DRAW_SIZE);
