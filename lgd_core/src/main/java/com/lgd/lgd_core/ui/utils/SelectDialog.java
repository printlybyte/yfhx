 ...
 * 选择对话框
 */
public final class SelectDialog extends Dialog implements OnClickListener, OnItemClickListener {
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (!mUseCustomColor) {
                mFirstItemColor = mActivity.getResources().getColor(R.color.cornflowerblue);
                mOtherItemColor = mActivity.getResources().getColor(R.color.cornflowerblue);
            }
            if (1 == mStrings.size()) {
